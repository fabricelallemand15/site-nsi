...
```
cd existing_repo
git remote add origin https://gitlab.com/sites32/site_nsi.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sites32/site_nsi/-/settings/integrations)
